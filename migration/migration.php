...
try {
    // Connexion à une base existante pour pouvoir créer la nouvelle base
    $dsn = "$driver:host=$host;port=$port;dbname=postgres"; // ✅ Ajout de dbname=postgres ici
    ...
    // 🔄 Connexion à la base fraîchement créée pour la suite
